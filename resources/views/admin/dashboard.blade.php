    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            @if(auth()->user()->is_admin)
                <h2 class="font-bold text-2xl text-gray-800">إدارة المشتركين</h2>
            ...
            @if(auth()->user()->is_admin)
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-gray-500 text-sm">اشتراكات Pro</p>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-gray-500 text-sm">حسابات Facebook</p>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="p-6 border-b border-gray-100">
                        <div class="flex items-center justify-between">
                            <h3 class="text-lg font-bold text-gray-800">قائمة المشتركين</h3>
                            <div class="flex items-center gap-4">
                                <input type="text" id="searchInput" placeholder="بحث..." class="border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="w-full">
                            <thead class="bg-gray-50 border-b border-gray-100">
                                <tr class="text-right text-sm text-gray-600">
                                    <th class="py-4 px-6 font-semibold">المشترك</th>
                                    <th class="py-4 px-6 font-semibold">البريد الإلكتروني</th>
                                    <th class="py-4 px-6 font-semibold text-center">الخطة</th>
                                    <th class="py-4 px-6 font-semibold text-center">Facebook</th>
                                    <th class="py-4 px-6 font-semibold text-center">الحالة</th>
                            ...
                            <tbody id="userTableBody" class="divide-y divide-gray-100">
                                ...
                                <tr class="hover:bg-gray-50 transition" data-user-id="{{ $user->id }}">
                                    ...
                                    <td class="py-4 px-6 text-center">
                                        <span class="bg-gray-100 text-gray-500 px-3 py-1 rounded-full text-xs">غير مربوط</span>
                                    </td>
                                    <td class="py-4 px-6 text-center">
                                        <span class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-semibold">نشط</span>
                                    </td>
                                    <td class="py-4 px-6 text-center">
                                ...
                                <tr>
                                    <td colspan="6" class="py-12 text-center text-gray-500">
                                        <p class="text-lg font-medium">لا يوجد مشتركين حالياً</p>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
 ...
 <div id="userModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
    <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div class="sticky top-0 bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between">
            <h3 id="modalTitle" class="text-xl font-bold text-gray-800">إضافة مشترك جديد</h3>
        ...
        <form id="userForm" action="{{ route('admin.users.store') }}" method="POST" class="p-6">
            ...
            <div class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">كلمة المرور (اختياري عند التعديل)</label>
        ...
        <input type="text" name="page_access_token" placeholder="EAAW..." class="w-full border border-gray-300 rounded-lg px-4 py-2.5 outline-none focus:ring-2 focus:ring-blue-500 transition text-sm">
            ...
            <div class="flex items-center gap-3 mt-6 pt-6 border-t border-gray-100">
                <button type="submit" id="submitBtn" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-lg transition flex items-center justify-center gap-2">
                    ...
                    <span id="submitBtnText">حفظ البيانات</span>
                </button>
                <button type="button" id="cancelBtn" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">إلغاء</button>
            </div>
        </form>
    </div>
</div>
